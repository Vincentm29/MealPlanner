...
<html>
    <head>
        <meta charset="utf-8" />
        <title>MealPlanner - Add Ingredient</title>
   ...
   <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    <body>
        ...
        <div><div class="form1">
            <form method="post" action="<c:url value="/addIngredient"/>" enctype="multipart/form-data">
                <fieldset>
                    <legend>Ingredient information</legend>
                    <c:import url="/inc/inc_ingredient_form.jsp" />
                </fieldset>  
