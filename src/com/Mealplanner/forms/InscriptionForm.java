...
import com.Mealplanner.beans.Utilisateur;
import com.Mealplanner.dao.DAOException;
import com.Mealplanner.dao.UtilisateurDao;
...
public final class InscriptionForm {
	...
	private void traiterMotsDePasse(String motDePasse, String confirmation,
		...
		String motDePasseChiffre = passwordEncryptor
				.encryptPassword(motDePasse);
	...
	private void validationMotsDePasse(String motDePasse, String confirmation)
		...
		if (motDePasse != null && confirmation != null) {
			if (!motDePasse.equals(confirmation)) {
				...
				throw new FormValidationException(
						"Les mots de passe doivent contenir au moins 3 caract̬res.");
			}
		} else {
			throw new FormValidationException(
